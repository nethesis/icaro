...
insert into hotspots values (null,2,"HSTest","HS for development",now());
...
insert into units values (null,1,'00-00-00-00-00-00','testunitname','testunitdesc','1234-uuid-aaaa','secret',NOW());
insert into users values (NULL, 1, 'First User', 'firstuser', 'firstpassword', 'first.user@nethserver.org', 'email', 0, 0, NOW(), NOW() + INTERVAL 3600 DAY, NOW());
