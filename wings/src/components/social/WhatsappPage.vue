    ...
    <div v-if="!dedaloRequested">
      <div v-if="choosedMode" class="field">
        ...
        <div class="ui big left icon input">
          <input disabled v-model="authSMS" type="tel" :placeholder="$t('sms.insert_number')" />
          <i class="talk icon"></i>
        </div>
      </div>
      ...
      <p v-if="!codeRequested && !choosedMode" class="not-code-exp">
        ...
        <br />
        <button v-on:click="getCode()" class="ui small button request-code">
          {{
          $t("sms.not_have_code") }}
        </button>
      </p>
  ...
  methods: {
    ...
    getCode: function(reset) {
      window.location.href =
        ...
        encodeURIComponent("join blood-his\nprovaprovaprova\nciaociaociao");
    },
    execLogin: function() {
